...
CREATE TABLE `todos` (
  ...
  `todo` varchar(45) COLLATE utf8mb3_turkish_ci NOT NULL,
  `duedate` varchar(45) COLLATE utf8mb3_turkish_ci NOT NULL,
  `duetime` varchar(45) COLLATE utf8mb3_turkish_ci NOT NULL,
  `priority` int(11) DEFAULT NULL,
  `status` varchar(45) COLLATE utf8mb3_turkish_ci DEFAULT NULL,
